...
status_t _ref_rnn_common_t::pd_t::init(impl::engine_t *engine) {
    ...
    bool is_l2r = !(rnn_conf.exec_dir == execution_direction_t::r2l);
    bool is_r2l = !(rnn_conf.exec_dir == execution_direction_t::l2r);
    bool is_sum = rnn_conf.exec_dir == execution_direction_t::bi_sum;
