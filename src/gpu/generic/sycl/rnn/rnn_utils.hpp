...
enum class execution_direction_t {
    l2r,
    r2l,
    bi_concat,
    bi_sum,
...
struct user_data_t : public data_helper_t {
    ...
    user_data_t(const mst &wei_layer, const memory_desc_wrapper &wei_layer_mdw,
            const mst &wei_iter, const memory_desc_wrapper &wei_iter_mdw,
            const mst &bias, const memory_desc_wrapper &bias_mdw)
